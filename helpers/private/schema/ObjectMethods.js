module.exports = (globalId, keyProps = [], saveToCache = false) => ({
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  // STATIC METHODS
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  [`get${globalId}`]: async function (params, dsName) {
    try {
      ...
      console.log('====================================');
      console.log(globalId, saveToCache);
      console.log('====================================');
      ...
      if (obj && obj.id) {
        if (saveToCache) {
          if (dsName) {
            ...
            global[`${globalId}Object`][`Available${globalId}s`][obj.id] = obj;
          }
        }
      } else {
